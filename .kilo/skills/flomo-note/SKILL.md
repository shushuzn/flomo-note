...
政策/（已建二级：产业 公共卫生 国资央企 房地产 教育 数字审查 数据 文化 方法论 生态 金融 **政务** **采购**；政务=政务服务/数字政府/行政效能当期解读，不进方法论；采购=政府采购/供应商问责/公共合同信任当期议题，不进方法论）科技/（已建：半导体 形式化验证 方法论 浏览器指纹 电动航空 科研体系 算力硬件）算力/（布局 战略 组织模式）
