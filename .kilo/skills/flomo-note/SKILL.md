...
投资/ 金融/ 会计/ 量子/ 物理/ 科技/（科研体系、技术产业通论）AI/（大模型与 agent）AI/应用构建（落地 AI 产品/工具）跑团/ 游戏/ 未竟/ 回环/ 媒体/（渠道层面）思想/（协调理论、社会制度、社科机制思辨）
政策/（已建二级：产业 公共卫生 国资央企 房地产 教育 数字审查 数据 文化 方法论 生态 金融 **政务**；政务=政务服务/数字政府/行政效能当期解读，不进方法论）科技/（已建：半导体 形式化验证 方法论 浏览器指纹 电动航空 科研体系 算力硬件）算力/（布局 战略 组织模式）
